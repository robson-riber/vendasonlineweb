        ...
        >
            <ProductInsertContainer>
                ...
                <LimitedContainer width={400}>
                    ...
                    <InputMoney onChange={(event) => onChange(event, 'price', true)} value={product.price} margem="0px 0px 17px 0px" title="Preço"  placeholder="Preço"/>
                ...
                <DisplayFlexJustifyRight>
                    <LimitedContainer width={120}>
                        <Button danger onClick={handleOnClickCancel} type="primary">Cancelar</Button>
                    </LimitedContainer>

                    <LimitedContainer width={120}>
                        <Button onClick={handleInsertProduct} type="primary">Salvar Produto</Button>
                    </LimitedContainer>
